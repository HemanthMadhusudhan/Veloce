...
var p = {
	capture: !0,
	passive: !1
}, m = 0, h = class s extends import_react.PureComponent {
	static xOrds = ["e", "w"];
	static yOrds = ["n", "s"];
	static xyOrds = [
		"nw",
	...
	componentRef = (0, import_react.createRef)();
	mediaRef = (0, import_react.createRef)();
	resizeObserver;
	initChangeCalled = !1;
	instanceId = `rc-${m++}`;
	state = {
	...
	renderCropSelection() {
		...
		if (o) return /* @__PURE__ */ import_react.createElement("div", {
			style: c,
			...
			role: "group"
		}, !n && !r && /* @__PURE__ */ import_react.createElement("div", {
			...
			role: "button"
		})), i && /* @__PURE__ */ import_react.createElement("div", {
			className: "ReactCrop__selection-addon",
			onPointerDown: (e) => e.stopPropagation()
		}, i(this.state)), a && /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement("div", { className: "ReactCrop__rule-of-thirds-hz" }), /* @__PURE__ */ import_react.createElement("div", { className: "ReactCrop__rule-of-thirds-vt" })));
	}
	makePixelCrop(e) {
		return u({
			...r,
	...
	render() {
		...
		}, n), o ? /* @__PURE__ */ import_react.createElement("svg", {
			className: "ReactCrop__crop-mask",
			width: "100%",
			height: "100%"
		}, /* @__PURE__ */ import_react.createElement("defs", null, /* @__PURE__ */ import_react.createElement("mask", { id: `hole-${this.instanceId}` }, /* @__PURE__ */ import_react.createElement("rect", {
			width: "100%",
			height: "100%",
			fill: "white"
		}), r ? /* @__PURE__ */ import_react.createElement("ellipse", {
