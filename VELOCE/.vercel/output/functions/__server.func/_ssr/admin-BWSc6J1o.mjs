...
import { a as useSiteImages, r as uploadSiteImageFile, t as SITE_IMAGE_META } from "./site-images-BbgsIyJj.mjs";
...
import { C as RefreshCcw, D as Pencil, K as CircleCheck, O as Package, Q as Boxes, R as LayoutGrid, W as ClipboardList, X as Check, b as RotateCw, c as Trash2, h as ShieldOff, i as Users, l as Timer, m as Shield, n as ZoomIn, q as CircleAlert, r as X, t as ZoomOut, tt as Ban, v as Search, w as Plus, x as RotateCcw, z as Image } from "../_libs/lucide-react.mjs";
import { i as SiteChrome } from "./chrome-pMKAbmf0.mjs";
import { n as useDrops, r as useHotSelling } from "./hot-selling-QTu4hdTq.mjs";
import { t as l } from "../_libs/react-cropper.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin-BWSc6J1o.js
...
function ImageCropper({ imageUrl, onCropComplete, onCancel }) {
	const cropperRef = (0, import_react.useRef)(null);
	const [aspectRatio, setAspectRatio] = (0, import_react.useState)(NaN);
	...
	const handleZoomSlide = (e) => {
		...
		if (cropper) cropper.zoomTo(Number(e.target.value));
	};
	const handleZoomIn = () => cropperRef.current?.cropper.zoom(.1);
	const handleZoomOut = () => cropperRef.current?.cropper.zoom(-.1);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "fixed inset-0 z-[200] flex items-center justify-center bg-black/90 p-2 sm:p-4 backdrop-blur-md animate-in fade-in",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex h-[95vh] w-[95vw] max-w-6xl flex-col overflow-hidden rounded-2xl bg-surface shadow-2xl border border-border/20",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex shrink-0 items-center justify-between border-b border-border/50 px-4 py-3 sm:px-6 sm:py-4 bg-background",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex-1 min-h-0 min-w-0 bg-black/60 relative",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex shrink-0 flex-col gap-4 border-t border-border/50 px-4 py-4 sm:px-6 bg-background",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-px h-6 bg-border/50 mx-1 sm:mx-2" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: handleReset,
									className: "rounded-full border border-border/60 p-2 text-muted-foreground hover:bg-white/10 hover:text-foreground transition-colors cursor-pointer",
									title: "Reset Image",
						...
						className: "flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-border/20",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-3",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [products.length, " products live. Changes apply globally."]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function DropsTab() {
	...
	const update = (id, patch) => setDrops(drops.map((x) => x.id === id ? {
		...x,
		...patch
	} : x));
	const add = () => setDrops([...drops, {
		id: `drop-${Date.now()}`,
		name: "New Drop",
		eyebrow: "Capsule",
	...
	const remove = (id) => setDrops(drops.filter((x) => x.id !== id));
