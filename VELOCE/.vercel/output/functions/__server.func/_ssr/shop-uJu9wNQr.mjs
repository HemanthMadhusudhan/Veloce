...
import { _ as useSearch, f as lazyRouteComponent, p as createFileRoute } from "../_libs/@tanstack/react-router+[...].mjs";
import { F as List, R as LayoutGrid, f as SlidersHorizontal, r as X } from "../_libs/lucide-react.mjs";
import { n as ProductCard } from "./ProductCard-D38gBGiM.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/shop-uJu9wNQr.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var $$splitComponentImporter = () => import("./shop-C2jsUzeM.mjs");
var Route = createFileRoute("/shop")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
function ShopInner({ title, subtitle, category }) {
	...
	const filtered = (0, import_react.useMemo)(() => {
		let list = category ? products.filter((p) => category === "football" ? p.category === "football" || p.category === "worldcup" : p.category === category) : products;
...
//#endregion
export { ShopInner as n, Route as t };
