...
import { A as Menu, B as Heart, J as ChevronRight, S as RefreshCw, U as Clock, V as Gift, Y as ChevronDown, _ as Settings, a as User, c as Trash2, et as Banknote, g as ShieldCheck, k as Minus, o as Truck, p as ShoppingBag, r as X, s as TrendingUp, v as Search, w as Plus } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/chrome-pMKAbmf0.js
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												onClick: () => {
													...
													const available = p?.stockBySize?.[item.size] !== void 0 ? p.stockBySize[item.size] : p?.stock ?? 0;
