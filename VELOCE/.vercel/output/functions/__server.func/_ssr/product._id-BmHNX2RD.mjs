...
import { i as useSiteImage } from "./site-images-BbgsIyJj.mjs";
import { t as formatINR } from "./product-4-DVDiSjDb.mjs";
import { t as CATEGORY_LABEL } from "./catalog-ChwsJiyw.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { B as Heart, J as ChevronRight, T as Play, b as RotateCw, g as ShieldCheck, o as Truck, p as ShoppingBag, r as X, u as Star } from "../_libs/lucide-react.mjs";
import { i as SiteChrome } from "./chrome-pMKAbmf0.mjs";
import { n as ProductCard } from "./ProductCard-D38gBGiM.mjs";
import { t as Route } from "./product._id-DNyqrTrU.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/product._id-BmHNX2RD.js
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: product.sizes.map((s) => {
										...
										const isOos = (sizeStock !== void 0 ? sizeStock : product.stock) <= 0;
										return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											onClick: () => {
												if (isOos) return;
												setSize(s);
												const newSizeStock = product.stockBySize?.[s] !== void 0 ? product.stockBySize[s] : product.stock;
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											onClick: () => setQty((q) => Math.min(product.stockBySize?.[size] !== void 0 ? product.stockBySize[size] : product.stock, q + 1)),
											className: "px-3 py-2",
											children: "+"
										})
									]
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [product.stock <= 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "flex w-full items-center justify-center gap-2 rounded-full border border-border/50 bg-surface/50 py-4 sm:py-3.5 text-[13px] sm:text-xs font-semibold uppercase tracking-[0.24em] text-muted-foreground cursor-not-allowed",
									...
									}, product.stockBySize?.[size] !== void 0 ? product.stockBySize[size] : product.stock),
