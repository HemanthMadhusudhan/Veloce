...
import { B as Gift, J as Check, N as Lock, Q as Banknote, d as Smartphone, n as Wallet } from "../_libs/lucide-react.mjs";
import { a as SiteNav, o as computeCart, r as SearchDialog, t as CartDrawer } from "./chrome-LNFqOEFI.mjs";
import { t as QRCodeSVG } from "../_libs/qrcode.react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/checkout-mHAXxH2D.js
...
function CheckoutPage() {
	...
	const upiUri = (0, import_react.useMemo)(() => {
							...
							children: [
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Wallet, { className: "h-3.5 w-3.5" }), " Full UPI"]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "text-[11px] text-muted-foreground",
												children: "One-shot UPI payment, order dispatched after verification."
											})
										]
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											className: "text-[10px] uppercase tracking-[0.24em] text-brand",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Smartphone, { style: {
												width: "14px",
												height: "14px",
												flexShrink: 0
											} }), " Scan & pay"]
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											...
											children: [
												...
												payMode === "cod" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: " (COD prepay charge)" }),
												"."
											]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: ["UPI transaction / UTR number", payMode === "cod" && " (for the ₹80 prepaid charge)"]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
										required: true,
										inputMode: "numeric",
										...
										value: txnId,
										onChange: (e) => {
											setTxnId(e.target.value.replace(/\D/g, "").slice(0, 12));
											setTxnErr(null);
										}
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-1.5 text-[11px] text-muted-foreground",
										children: "After paying, paste the 12-digit UTR from your UPI app. Your order stays \"awaiting payment\" until we confirm the UTR against our bank — fake or wrong numbers will be rejected."
									}),
									txnErr && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-2 rounded-lg border border-brand/40 bg-brand/10 px-3 py-2 text-[11px] text-brand",
										children: txnErr
									})
								] }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
