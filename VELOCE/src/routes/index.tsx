      ...
      <div className="sm:hidden -mt-[76px]">
          ...
          <div className="relative z-10 mx-auto flex h-full flex-col justify-end px-4 pb-8 pt-20">
            <div className="animate-reveal">
              ...
              <h1 className="font-display text-2xl font-bold leading-[0.95] tracking-tight text-foreground">
                Precision.
                <br />
                Rendered <span className="italic text-brand">in fabric.</span>
              </h1>
              <div className="mt-2 inline-flex max-w-full items-center gap-1.5 rounded-full border border-brand/40 bg-brand/10 px-2.5 py-1 text-[8px] uppercase tracking-[0.15em] text-brand">
                ...
                <span className="truncate">BUY 2 GET 1 FREE · CODE B2G1</span>
              </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 z-10 border-t border-white/10 bg-background/40 backdrop-blur">
            <div className="flex items-center gap-4 overflow-hidden px-4 py-2 font-mono text-[8px] uppercase tracking-[0.2em] text-muted-foreground">
              <span className="flex items-center gap-1.5">
                <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-brand" /> LIVE · Monza
                Drop
              </span>
            </div>
          </div>
        ...
        <section className="w-full grid grid-cols-2 gap-1 bg-background pt-1">
          <Link to="/shop/football" className="relative block w-full aspect-square overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center p-3 text-center">
              <h2 className="font-display text-2xl sm:text-3xl font-bold tracking-widest text-white drop-shadow-md">
                FOOTBALL
              </h2>
            </div>
          </Link>
        ...
        <section className="w-full bg-gradient-to-b from-surface/80 to-background py-6 px-4 text-center border-b border-border/40">
          <p className="text-[13px] leading-relaxed text-foreground max-w-[300px] mx-auto">
            <span className="font-bold">Player Version Football Jerseys at just ₹599!</span>{" "}
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-3">
                    <span className="block text-[11px] font-bold tracking-widest text-white uppercase truncate">
                      {z.name}
                    </span>
                    <span className="block mt-0.5 text-[9px] text-white/70 uppercase tracking-widest truncate">
                      {z.category === "f1" ? "The Paddock" : "The Pitch"}
                    </span>
                  </div>
                </Link>
              );
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-5 pb-16 pt-44 sm:px-6 sm:pb-24 sm:pt-48">
          <div className="animate-reveal">
            ...
            <h1 className="font-display text-[2rem] xs:text-[2.4rem] font-bold leading-[0.95] tracking-tight text-foreground sm:text-6xl md:text-[clamp(3rem,7vw,6rem)]">
              ...
              Rendered
              <br />
              <span className="italic text-brand">in fabric.</span>
            </h1>
            <p className="mt-4 max-w-lg text-[12px] leading-relaxed text-muted-foreground sm:text-base">
              Elite football jerseys and Formula 1 team merchandise, delivered with the craft of a
              couture atelier. Every piece authenticated. Every stitch, engineered.
            </p>
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 border-t border-white/10 bg-background/40 backdrop-blur">
          <div className="flex items-center gap-6 overflow-hidden px-4 py-2.5 font-mono text-[9px] uppercase tracking-[0.22em] text-muted-foreground sm:gap-8 sm:px-6 sm:py-3 sm:text-[10px] sm:tracking-[0.28em]">
            <span className="flex items-center gap-2">
              <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-brand" /> LIVE · Monza GP
              Drop
            </span>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-surface via-background to-surface p-6 sm:p-14">
            <div className="grid gap-10 md:grid-cols-2 md:items-center">
              <div>
                ...
                <h2 className="mt-3 font-display text-2xl font-bold leading-tight sm:text-6xl">
                  {drop.name}.
                </h2>
                <p className="mt-4 max-w-md text-xs text-muted-foreground sm:text-sm">
                  Numbered edition. Individually authenticated. Once it's gone, it's archived
                  forever.
                </p>
                <div className="mt-6 grid grid-cols-4 gap-2 sm:mt-8 sm:gap-3">
                  {[
                    ...
                    >
                      <div className="font-mono text-lg font-bold sm:text-3xl">
          ...
          {REVIEWS.map((r, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-1">
                <div className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-full bg-brand/20 text-[10px] sm:text-xs font-bold text-brand">
                  {r.name
                    .split(" ")
                    .map((n) => n[0])
                    .join("")}
