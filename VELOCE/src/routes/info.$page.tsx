...
> = {
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            To make world-class sports merchandise accessible to every passionate fan. We believe
        ...
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong className="text-foreground">100% Authentic:</strong> Every jersey is sourced
                through verified channels and comes with an authenticity guarantee.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-brand shrink-0" />
              <span>
                <strong className="text-foreground">Player-Version Quality:</strong> Premium
                fabrics, precision stitching, and attention to detail that matches what the pros
                wear.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-brand shrink-0" />
              <span>
                <strong className="text-foreground">Custom Printing:</strong> Add your name and
                number to make every jersey truly yours.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-brand shrink-0" />
        ...
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            We're a small, passionate team of sports fans, designers, and logistics experts based in
            India. Every order is handled with the same excitement we feel when our favourite team
            scores a last-minute winner.
          </p>
        </div>
      </div>
    ),
      ...
      <div className="space-y-6">
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-3">
          ...
          <h3 className="font-display text-lg font-semibold">
            FIFA World Cup 2026 Collection is Here!
          </h3>
          <p className="text-sm text-muted-foreground leading-relaxed">
            The biggest tournament in football history is upon us. We've curated jerseys from all 48
            participating nations — from powerhouses like Brazil and Germany to dark horses making
            their World Cup debut. Shop the full collection now and wear your nation's colours with
            pride.
          </p>
        </div>
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Relive the golden moments of football with our retro collection. From the iconic 1998
            France home shirt to the legendary 2006 Italy kit, these timeless designs are back in
        ...
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            The 2026 F1 season is heating up! We've added the latest team merchandise from Scuderia
            Ferrari, McLaren, Red Bull Racing, Mercedes-AMG, and Aston Martin. Rep your constructor
            from the grandstand or your living room.
          </p>
        </div>
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Our most-requested deal is finally here. Add 3 jerseys to your cart and the cheapest one
            is automatically free. Use code B2G1 or just add 3 items — the discount applies
            automatically. No catch, no fine print.
          </p>
        </div>
      </div>
    ),
    ...
    content: () => (
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            All our orders are shipped in 100% recyclable packaging. We've eliminated single-use
            plastics from our supply chain and use biodegradable mailers made from cornstarch.
          </p>
        </div>
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          <h3 className="font-display text-lg font-semibold">♻️ Responsible Sourcing</h3>
          <p className="text-sm text-muted-foreground leading-relaxed">
            We partner with manufacturers who prioritise ethical labour practices and sustainable
            materials. Our jerseys are made with recycled polyester where possible, reducing waste
        ...
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            We consolidate shipments and work with logistics partners who offer carbon-neutral
            delivery options. Our goal is to offset 100% of our shipping emissions by 2027.
          </p>
        </div>
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          <h3 className="font-display text-lg font-semibold">🤝 Community Giveback</h3>
          <p className="text-sm text-muted-foreground leading-relaxed">
            For every 100 jerseys sold, we donate a jersey to underprivileged young athletes through
            our partner NGOs. Because every kid deserves to feel like a champion.
          </p>
        </div>
      </div>
    ),
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-3">
              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-brand shrink-0" />
              <span>Work with a young, energetic team that breathes sports</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-brand shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-brand shrink-0" />
              <span>Free jerseys (obviously!)</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-brand shrink-0" />
              <span>Competitive pay + performance bonuses</span>
            </li>
          </ul>
        </div>
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            We don't have any specific openings right now, but we're always excited to hear from
            talented people. Send us your resume and a note about why you'd be a great fit!
          </p>
          <p className="text-sm text-muted-foreground">
            📧 Email:{" "}
            <a href="mailto:careers@velocejersey.com" className="text-brand hover:underline">
              careers@velocejersey.com
            </a>
          </p>
        </div>
      </div>
  ...
  contact: {
    ...
    content: () => (
      <div className="space-y-6">
        <p className="text-muted-foreground leading-relaxed">
          Got a question, concern, or just want to talk jerseys? We'd love to hear from you. Our
          support team typically responds within 4–6 hours.
        </p>
        ...
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              📦 <strong className="text-foreground">Order tracking:</strong> Reply to your order
              confirmation email, or DM us on Instagram.
            </li>
            <li>
              🔄 <strong className="text-foreground">Exchange/Return:</strong> Visit our Returns
              page for the step-by-step process.
            </li>
            <li>
              👕 <strong className="text-foreground">Size guide:</strong> Check the size chart on
              any product page before ordering.
            </li>
            <li>
              🎁 <strong className="text-foreground">Bulk orders:</strong> Planning for a club or
              group? Email us for special pricing.
            </li>
          </ul>
        </div>
      </div>
    ...
    content: () => (
      <div className="space-y-6">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border/50 text-left">
                  <th className="pb-3 text-muted-foreground font-medium">Order Value</th>
                  <th className="pb-3 text-muted-foreground font-medium">Shipping Cost</th>
                  <th className="pb-3 text-muted-foreground font-medium">Delivery Time</th>
                </tr>
              </thead>
        ...
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            We deliver across all of India including metros, tier-2, and tier-3 cities. Remote areas
            may take 1–2 extra business days.
          </p>
        </div>
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          <h3 className="font-display text-lg font-semibold">COD Available</h3>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Pay a small ₹80 prepaid charge online at checkout to confirm your order, and pay the
            remaining balance in cash when your order is delivered.
          </p>
        </div>
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            track your order in real-time through our logistics partner's website.
          </p>
        </div>
      </div>
    ),
    ...
    content: () => (
      <div className="space-y-6">
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Not the right size? No worries! You can exchange your jersey within 4 days of delivery.
            The product must be unused, unwashed, and in its original packaging with all tags
            attached.
          </p>
        </div>
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <ol className="space-y-3 text-sm text-muted-foreground list-decimal list-inside">
            ...
            <li>
              Your replacement will be shipped within 2 business days of receiving the return.
            </li>
          </ol>
        </div>
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-3">
              ...
              <span>Custom printed jerseys (with name/number)</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-red-500 shrink-0" />
              <span>Items that have been washed or worn</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-red-500 shrink-0" />
              <span>Items without original tags and packaging</span>
            </li>
          </ul>
        </div>
        <div className="rounded-2xl border border-border/50 bg-card/40 p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            We currently offer exchanges only (no direct refunds). If the same product isn't
            available in your preferred size, we'll issue store credit valid for 6 months.
          </p>
        </div>
      </div>
    ),
